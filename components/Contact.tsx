          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-4" aria-describedby={statusId}>
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 focus:ring-offset-gray-800"
                >
                  Send Message
                </button>
